module.exports = function () {
  return {
    black: [
      ...
      {
        id: 'b013',
        text: 'What ended my relationship?'
      },
      {
        id: 'b014',
        text: 'MTV\'s new reality show features washed-up celebrities living with __________.'
      },
      {
        id: 'b015',
      ...
      {
        id: 'b022',
        text: 'For my next trick, I will pull _____ out of __________.',
        pick: 2
      },
      {
        id: 'b023',
      ...
      {
        id: 'b030',
        text: 'Introducing the amazing superhero/sidekick duo! It\'s _____ and _____!',
        pick: 2
      },
      {
        id: 'b031',
        text: 'In M. Night Shyamalan\'s new movie, Bruce Willis discovers that _____ had really been __________ all along.',
        pick: 2
      },
      {
        id: 'b032',
      ...
      {
        id: 'b036',
        text: 'Now from J.K. Rowling: Harry Potter and the Chamber of __________.'
      },
      {
        id: 'b037',
        text: 'Introducing Xtreme Baseball! It\'s like baseball, but with __________!'
      },
      {
        id: 'b038',
      ...
      {
        id: 'b054',
        text: 'They said we were crazy. They said we couldn\'t put _____ inside of __________. They were wrong.',
        pick: 2
      },
      {
        id: 'b055',
      ...
      {
        id: 'b064',
        text: 'What did the U.S. airdrop to the children in Afghanistan?'
      },
      {
        id: 'b065',
      ...
      {
        id: 'b081',
        text: 'When I am President of the United States, I will create Department of __________.'
      },
      {
        id: 'b082',
        text: 'Lifetime(R) presents "__________, the Story of __________."',
        pick: 2
      },
      {
        id: 'b083',
    ...
    white: [
      ...
      {
        id: 'w023',
        text: 'The Tempur-Pedic(R) Swedish Sleep System.'
      },
      {
        id: 'w024',
        text: 'Scientology.'
      ...
      {
        id: 'w324',
        text: 'Home video of Oprah sobbing into a Lean Cuisine(R).'
      },
      {
        id: 'w325',
      ...
      {
        id: 'w329',
        text: 'The cool, refreshing taste of Pepsi(R).'
      },
      {
        id: 'w330',
